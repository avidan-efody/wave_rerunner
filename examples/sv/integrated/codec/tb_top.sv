...
initial
begin
   uvm_config_db#(tb_ctl_vif)::set(null, "uvm_test_top.env", "vif", tb_top.ctl);
   uvm_config_db#(apb_vif)::set(null, "uvm_test_top.env.apb", "vif", tb_top.apb0);
   uvm_config_db#(vip_vif)::set(null, "uvm_test_top.env.vip", "vif", tb_top.vip0);
